// /watch/[id] (HOME-04 stub).
//
// A MINIMAL placeholder route so every VideoCard / hero slide link resolves
// to a real prerendered page. The full watch page (WCH-01) REPLACES the
// +page.svelte with the full Vimeo/YouTube player + metadata + related
